---
name: pf-init
description: Initialize or refresh a ProductForge .product workspace for a repo or product. Use when creating PRODUCT.md, REQUIREMENTS.md, ROADMAP.md, STATE.md, config.yaml, references, and initial product context for professional PM workflows.
---
...
Summarize initialized files, mapped docs, assumptions, and next recommended `pf-*` command.
