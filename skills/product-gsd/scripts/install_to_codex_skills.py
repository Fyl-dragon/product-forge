...
def main() -> int:
    parser = argparse.ArgumentParser(description="Install the local Product GSD skill pack into ~/.codex/skills.")
    parser.add_argument("--source", default=".product/skill-pack", help="Local skill-pack directory.")
