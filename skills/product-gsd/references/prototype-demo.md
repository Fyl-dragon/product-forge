# Prototype Demo Standard

The default prototype is a lightweight demo, not a static mock and not a production app.
...
- `spec/product-spec.json`: pages, components, entities, fields, statuses, actions, permissions.
