...
Use this checklist for `$pgd-review`.
...
- Are entities and fields complete enough for implementation discussion?
...
- P1: likely causes implementation ambiguity or user-visible failure
